...
ItemSet.prototype.setOptions = function(options) {
  if (options) {
    ...
    if ('customAction' in options) {
      if (typeof options.customAction === 'boolean') {
        this.options.customAction.title        = options.customAction;
        this.options.customAction.className    = options.customAction;
        this.options.customAction.onClick      = options.customAction;
      }
      else if (typeof options.customAction === 'object') {
        util.selectiveExtend(['title', 'className', 'onClick'], this.options.customAction, options.customAction);
      }
    }
